...
World Health Organization (WHO) projected that there will be nearly 2.5 billion people in the world having hearing loss by 2050 and emphasized that sign language related applications are essential tools for deaf people \cite{WHO2050}.
...
Although there is no unified international sign language yet, the major sign language systems such as USA, British, France and China have developed fingerspelling, also called "Sign Language Alphabet (SLA)." SLA represents the 26 common alphabets (A to Z) and local special letters using only hand gestures, mostly in difficult words such as personal names, place names and technical terms, etc. Additionally, it can also be used to facilitate easier communication when encountering issues with sign language dialects. 
...
\subsection{Sign Language Alphabet Recognition (SLA)}

\subsection{Convonlutional Network (CNN)}

\subsection{You Look Only Once (Yolo)}
