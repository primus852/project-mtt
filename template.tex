...
Sign language is a form of visual communication that replaces speaking and listening, using gestures, body movements and facial expressions to convey meaning. Sign language can be used for different purposes in different situations, but it is primarily designed for communication with the deaf. As it is more visually accessible to the deaf, sign language is a natural method of communication for the deaf and can express a wide range of meanings in the same way as spoken language; for example, American Sign Language is used by deaf people in the United States and some provinces of Canada, British Sign Language is used by deaf people in the UK, French Sign Language in France, Japanese Sign Language in Japan and Chinese Sign Language in China.

Although there is no unified international sign language yet, but these major sign language systems like USA, British, France and China have developed fingerspelling, also called "Sign Language Alphabet (SLA)." SLA represents the 26 common alphabet (A to Z) and local special letters, mostly in difficult words such as personal names, place names and technical terms. Additionally, it can also be used to facilitate easier communication when encountering issues with sign language dialects.

In the past decade, deep learning has shown excellent performance in image recognition, enabling new breakthroughs in sign language recognition technology. Most studies have used neural networks to convert static SLA signals into text or speech and the main approach includes data acquisition technique, static signs, classification with over 90\% accuracy of recognition.\cite{wadhawan2021sign}  

This paper will focus on the use of Few-Shot Learning and transfer learning of Convolutional Neural Networks (CNN) with Object Detection in real time to translate sign language alphabets into other sign language alphabets, thereby helping deaf people to communicate with each other without learning a new sign language.
