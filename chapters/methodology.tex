...
\intertext{N_\textit{c}=\textit{Number of classes}}\break
\intertext{TP_\textit{i} = \textit{Count of true positive predictions for given class},
}\break
\intertext{TN_\textit{i} = \textit{Count of true negative predictions for given class} },\break
\intertext{FP_\textit{i} = \textit{Count of false positive predictions for given class},
}\break
\intertext{FN_\textit{i} = \textit{Count of false negative predictions for given class}
}\break
